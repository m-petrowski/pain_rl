...
experiment_folder_path = root_folder_path + "lifetime/"
...
grid_search = GridSearchRunner(base_config=base_config, param_grid=param_grid, config_save_dir=experiment_folder_path + "configs/", results_file=experiment_folder_path + "results_lifetime.csv")
grid_search.run()